...
export class CrossMarginAccountFactory__factory {
	...
	static connect(address: string, signerOrProvider: Signer | Provider): CrossMarginAccountFactory {
		return new Contract(address, _abi, signerOrProvider) as CrossMarginAccountFactory;
	}
}
