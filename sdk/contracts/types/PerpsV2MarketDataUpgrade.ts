...
export interface PerpsV2MarketDataUpgradeInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketDataUpgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketDataUpgradeInterface;
