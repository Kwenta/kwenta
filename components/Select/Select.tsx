	...
	const computedStyles = useMemo(() => {
		const styles: StylesConfig = {
			...
			control: (provided, state) => ({
				...
				color: colors.white,
				cursor: 'pointer',
				boxShadow: colors.defaultTheme.select.control.shadow,

				border: colors.defaultTheme.border,
				outline: 'none',
				minHeight: 'unset',
				...
				fontSize: '12px',
				background: colors.defaultTheme.button.background,
				borderRadius: '16px',
			}),
			menu: (provided, state) => ({
				...provided,
				...
				borderRadius: '8px',
				boxShadow: colors.defaultTheme.button.shadow,
				padding: 0,
