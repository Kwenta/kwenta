...
const StyledSlider = styled(Slider)`
	...
	.MuiSlider-track {
		...
		box-shadow: ${(props) => props.theme.colors.eliteTheme.slider.track.shadow};
		margin-top: -3px;
		border-radius: 2px;
		margin-left: 1px;
		margin-right: 4px;
	...
	.MuiSlider-thumb {
		...
		box-shadow: ${(props) => props.theme.colors.eliteTheme.slider.thumb.hover.shadow} !important;
		width: 14px;
		height: 14px;
		margin-left: initial;
		margin-top: -8px;
	...
	.MuiSlider-markLabel {
		...
		font-size: 11px;
		color: ${(props) => props.theme.colors.eliteTheme.slider.label};
		margin-left: 8px;
	}
