...
export const fetchFundingRates = createAsyncThunk<void, string, ThunkConfig>(
	'futures/fetchFundingRates',
	async (marketAddress, { extra: { sdk } }) => {
		await sdk.futures.getMarketFundingRates(marketAddress);
	}
);
