...
const DashboardContainer: FC = () => {
	...
	const TABS = useMemo(
		() => [
			...
			{
				name: Tab.Histories,
				label: t('futures-dashboard.tabs.nav.histories'),
				active: activeTab === Tab.Histories,
				onClick: () => router.push(ROUTES.Home.Histories),
			},
			{
				name: Tab.Rewards,
	...
	return (
		<>
			...
			<MainContent>
				...
				<TabPanel name={Tab.Histories} activeTab={activeTab}>
					<Histories />
				</TabPanel>
