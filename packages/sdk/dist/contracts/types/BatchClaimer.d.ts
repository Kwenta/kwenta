...
export interface BatchClaimerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "claimMultiple", values: [
...
export interface BatchClaimer extends BaseContract {
    ...
    functions: {
        claimMultiple(_distributors: PromiseOrValue<string>[], _claims: IMultipleMerkleDistributor.ClaimsStruct[][], overrides?: Overrides & {
    ...
    callStatic: {
        claimMultiple(_distributors: PromiseOrValue<string>[], _claims: IMultipleMerkleDistributor.ClaimsStruct[][], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        claimMultiple(_distributors: PromiseOrValue<string>[], _claims: IMultipleMerkleDistributor.ClaimsStruct[][], overrides?: Overrides & {
