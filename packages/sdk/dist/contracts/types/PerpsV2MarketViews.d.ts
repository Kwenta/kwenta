...
export interface PerpsV2MarketViews extends BaseContract {
    ...
    functions: {
        ...
        positions(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[IPerpsV2MarketBaseTypes.PositionStructOutput]>;
