...
export interface StakingRewardsInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptOwnership" | "balanceOf" | "earned" | "exit" | "getReward" | "getRewardForDuration" | "lastPauseTime" | "lastTimeRewardApplicable" | "lastUpdateTime" | "nominateNewOwner" | "nominatedOwner" | "notifyRewardAmount" | "owner" | "paused" | "periodFinish" | "recoverERC20" | "rewardPerToken" | "rewardPerTokenStored" | "rewardRate" | "rewards" | "rewardsDistribution" | "rewardsDuration" | "rewardsToken" | "setPaused" | "setRewardsDistribution" | "setRewardsDuration" | "stake" | "stakingToken" | "totalSupply" | "userRewardPerTokenPaid" | "withdraw"): FunctionFragment;
...
export interface StakingRewards extends BaseContract {
    ...
    functions: {
        ...
        setRewardsDistribution(_rewardsDistribution: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
