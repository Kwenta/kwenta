...
export declare const getCandleById: <K extends keyof CandleResult>(url: string, options: SingleQueryOptions, args: CandleArgs<K>) => Promise<Pick<CandleResult, K>>;
export declare const getCandles: <K extends keyof CandleResult>(url: string, options: MultiQueryOptions<CandleFilter, CandleResult>, args: CandleArgs<K>) => Promise<Pick<CandleResult, K>[]>;
...
export declare const getCrossMarginAccountById: <K extends keyof CrossMarginAccountResult>(url: string, options: SingleQueryOptions, args: CrossMarginAccountArgs<K>) => Promise<Pick<CrossMarginAccountResult, K>>;
export declare const getCrossMarginAccounts: <K extends keyof CrossMarginAccountResult>(url: string, options: MultiQueryOptions<CrossMarginAccountFilter, CrossMarginAccountResult>, args: CrossMarginAccountArgs<K>) => Promise<Pick<CrossMarginAccountResult, K>[]>;
...
export type CrossMarginAccountTransferArgs<K extends keyof CrossMarginAccountTransferResult> = {
    [Property in keyof Pick<CrossMarginAccountTransferFields, K>]: CrossMarginAccountTransferFields[Property];
};
export declare const getCrossMarginAccountTransferById: <K extends keyof CrossMarginAccountTransferResult>(url: string, options: SingleQueryOptions, args: CrossMarginAccountTransferArgs<K>) => Promise<Pick<CrossMarginAccountTransferResult, K>>;
export declare const getCrossMarginAccountTransfers: <K extends keyof CrossMarginAccountTransferResult>(url: string, options: MultiQueryOptions<CrossMarginAccountTransferFilter, CrossMarginAccountTransferResult>, args: CrossMarginAccountTransferArgs<K>) => Promise<Pick<CrossMarginAccountTransferResult, K>[]>;
...
export declare const getFundingPaymentById: <K extends keyof FundingPaymentResult>(url: string, options: SingleQueryOptions, args: FundingPaymentArgs<K>) => Promise<Pick<FundingPaymentResult, K>>;
export declare const getFundingPayments: <K extends keyof FundingPaymentResult>(url: string, options: MultiQueryOptions<FundingPaymentFilter, FundingPaymentResult>, args: FundingPaymentArgs<K>) => Promise<Pick<FundingPaymentResult, K>[]>;
...
export declare const getFundingRateUpdateById: <K extends keyof FundingRateUpdateResult>(url: string, options: SingleQueryOptions, args: FundingRateUpdateArgs<K>) => Promise<Pick<FundingRateUpdateResult, K>>;
export declare const getFundingRateUpdates: <K extends keyof FundingRateUpdateResult>(url: string, options: MultiQueryOptions<FundingRateUpdateFilter, FundingRateUpdateResult>, args: FundingRateUpdateArgs<K>) => Promise<Pick<FundingRateUpdateResult, K>[]>;
...
export declare const getFuturesAggregateStatById: <K extends keyof FuturesAggregateStatResult>(url: string, options: SingleQueryOptions, args: FuturesAggregateStatArgs<K>) => Promise<Pick<FuturesAggregateStatResult, K>>;
export declare const getFuturesAggregateStats: <K extends keyof FuturesAggregateStatResult>(url: string, options: MultiQueryOptions<FuturesAggregateStatFilter, FuturesAggregateStatResult>, args: FuturesAggregateStatArgs<K>) => Promise<Pick<FuturesAggregateStatResult, K>[]>;
...
export declare const getFuturesCumulativeStatById: <K extends keyof FuturesCumulativeStatResult>(url: string, options: SingleQueryOptions, args: FuturesCumulativeStatArgs<K>) => Promise<Pick<FuturesCumulativeStatResult, K>>;
export declare const getFuturesCumulativeStats: <K extends keyof FuturesCumulativeStatResult>(url: string, options: MultiQueryOptions<FuturesCumulativeStatFilter, FuturesCumulativeStatResult>, args: FuturesCumulativeStatArgs<K>) => Promise<Pick<FuturesCumulativeStatResult, K>[]>;
...
export declare const getFuturesMarginAccountById: <K extends keyof FuturesMarginAccountResult>(url: string, options: SingleQueryOptions, args: FuturesMarginAccountArgs<K>) => Promise<Pick<FuturesMarginAccountResult, K>>;
export declare const getFuturesMarginAccounts: <K extends keyof FuturesMarginAccountResult>(url: string, options: MultiQueryOptions<FuturesMarginAccountFilter, FuturesMarginAccountResult>, args: FuturesMarginAccountArgs<K>) => Promise<Pick<FuturesMarginAccountResult, K>[]>;
...
export declare const getFuturesMarginTransferById: <K extends keyof FuturesMarginTransferResult>(url: string, options: SingleQueryOptions, args: FuturesMarginTransferArgs<K>) => Promise<Pick<FuturesMarginTransferResult, K>>;
export declare const getFuturesMarginTransfers: <K extends keyof FuturesMarginTransferResult>(url: string, options: MultiQueryOptions<FuturesMarginTransferFilter, FuturesMarginTransferResult>, args: FuturesMarginTransferArgs<K>) => Promise<Pick<FuturesMarginTransferResult, K>[]>;
...
export declare const getFuturesMarketById: <K extends keyof FuturesMarketResult>(url: string, options: SingleQueryOptions, args: FuturesMarketArgs<K>) => Promise<Pick<FuturesMarketResult, K>>;
export declare const getFuturesMarkets: <K extends keyof FuturesMarketResult>(url: string, options: MultiQueryOptions<FuturesMarketFilter, FuturesMarketResult>, args: FuturesMarketArgs<K>) => Promise<Pick<FuturesMarketResult, K>[]>;
...
export declare const getFuturesOrderById: <K extends keyof FuturesOrderResult>(url: string, options: SingleQueryOptions, args: FuturesOrderArgs<K>) => Promise<Pick<FuturesOrderResult, K>>;
export declare const getFuturesOrders: <K extends keyof FuturesOrderResult>(url: string, options: MultiQueryOptions<FuturesOrderFilter, FuturesOrderResult>, args: FuturesOrderArgs<K>) => Promise<Pick<FuturesOrderResult, K>[]>;
...
export declare const getFuturesPositionById: <K extends keyof FuturesPositionResult>(url: string, options: SingleQueryOptions, args: FuturesPositionArgs<K>) => Promise<Pick<FuturesPositionResult, K>>;
export declare const getFuturesPositions: <K extends keyof FuturesPositionResult>(url: string, options: MultiQueryOptions<FuturesPositionFilter, FuturesPositionResult>, args: FuturesPositionArgs<K>) => Promise<Pick<FuturesPositionResult, K>[]>;
...
export declare const getFuturesStatById: <K extends keyof FuturesStatResult>(url: string, options: SingleQueryOptions, args: FuturesStatArgs<K>) => Promise<Pick<FuturesStatResult, K>>;
export declare const getFuturesStats: <K extends keyof FuturesStatResult>(url: string, options: MultiQueryOptions<FuturesStatFilter, FuturesStatResult>, args: FuturesStatArgs<K>) => Promise<Pick<FuturesStatResult, K>[]>;
...
export declare const getFuturesTradeById: <K extends keyof FuturesTradeResult>(url: string, options: SingleQueryOptions, args: FuturesTradeArgs<K>) => Promise<Pick<FuturesTradeResult, K>>;
export declare const getFuturesTrades: <K extends keyof FuturesTradeResult>(url: string, options: MultiQueryOptions<FuturesTradeFilter, FuturesTradeResult>, args: FuturesTradeArgs<K>) => Promise<Pick<FuturesTradeResult, K>[]>;
...
export declare const getSmartMarginAccountById: <K extends keyof SmartMarginAccountResult>(url: string, options: SingleQueryOptions, args: SmartMarginAccountArgs<K>) => Promise<Pick<SmartMarginAccountResult, K>>;
export declare const getSmartMarginAccounts: <K extends keyof SmartMarginAccountResult>(url: string, options: MultiQueryOptions<SmartMarginAccountFilter, SmartMarginAccountResult>, args: SmartMarginAccountArgs<K>) => Promise<Pick<SmartMarginAccountResult, K>[]>;
export type FuturesAccountType = 'isolated_margin' | 'cross_margin' | 'smart_margin';
export type FuturesOrderType = 'NextPrice' | 'Limit' | 'Market' | 'StopMarket' | 'Delayed' | 'DelayedOffchain';
