...
export type SynthSuspensionReason = 'system-upgrade' | 'market-closure' | 'circuit-breaker' | 'emergency';
...
export declare enum FuturesMarketKey {
    sBTCPERP = "sBTCPERP",
    sETHPERP = "sETHPERP",
    sLINKPERP = "sLINKPERP",
    sSOLPERP = "sSOLPERP",
...
export declare enum FuturesMarketAsset {
    sBTC = "sBTC",
    sETH = "sETH",
    LINK = "LINK",
    SOL = "SOL",
...
export declare enum ContractOrderType {
    MARKET = 0,
    DELAYED = 1,
    DELAYED_OFFCHAIN = 2
}
export declare const OrderEnumByType: Record<string, ContractOrderType>;
...
export type FuturesOrderTypeDisplay = 'Next Price' | 'Limit' | 'Stop' | 'Market' | 'Liquidation' | 'Delayed' | 'Take Profit' | 'Stop Loss' | 'Delayed Market';
export declare enum ConditionalOrderTypeEnum {
    LIMIT = 0,
    STOP = 1
}
...
export declare enum PotentialTradeStatus {
    OK = 0,
    INVALID_PRICE = 1,
...
export declare enum AccountExecuteFunctions {
