...
exports.getSynthsListForNetwork = exports.getSynthsForNetwork = exports.synths = void 0;
exports.synths = {
    sAAVE: {
        name: 'Aave',
        asset: 'AAVE',
...
const synthsByNetwork = (id) => Object.entries(exports.synths).reduce((acc, [symbol, config]) => {
...
const getSynthsForNetwork = (networkId) => {
    var _a, _b;
    return (_b = (_a = SYNTHS_BY_NETWORK[networkId]) === null || _a === void 0 ? void 0 : _a.map) !== null && _b !== void 0 ? _b : {};
};
exports.getSynthsForNetwork = getSynthsForNetwork;
const getSynthsListForNetwork = (networkId) => {
    var _a, _b;
    return (_b = (_a = SYNTHS_BY_NETWORK[networkId]) === null || _a === void 0 ? void 0 : _a.list) !== null && _b !== void 0 ? _b : [];
};
exports.getSynthsListForNetwork = getSynthsListForNetwork;
