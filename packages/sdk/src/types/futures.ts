...
export enum AccountExecuteFunctions {
	...
	UNISWAP_V3_SWAP = 2,
	PERMIT2_PERMIT = 3,
	PERPS_V2_MODIFY_MARGIN = 4,
	PERPS_V2_WITHDRAW_ALL_MARGIN = 5,
	PERPS_V2_SUBMIT_ATOMIC_ORDER = 6,
	PERPS_V2_SUBMIT_DELAYED_ORDER = 7,
	PERPS_V2_SUBMIT_OFFCHAIN_DELAYED_ORDER = 8,
	PERPS_V2_CLOSE_POSITION = 9,
	PERPS_V2_SUBMIT_CLOSE_DELAYED_ORDER = 10,
	PERPS_V2_SUBMIT_CLOSE_OFFCHAIN_DELAYED_ORDER = 11,
	PERPS_V2_CANCEL_DELAYED_ORDER = 12,
	PERPS_V2_CANCEL_OFFCHAIN_DELAYED_ORDER = 13,
	GELATO_PLACE_CONDITIONAL_ORDER = 14,
