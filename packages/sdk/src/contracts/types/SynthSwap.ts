...
export interface SynthSwapInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'rescueFunds', values: [string, BigNumberish]): string
	encodeFunctionData(functionFragment: 'swapInto', values: [BytesLike, BytesLike]): string
	encodeFunctionData(
...
export type SwapIntoEvent = TypedEvent<[string, BigNumber], SwapIntoEventObject>
...
export type SwapOutOfEvent = TypedEvent<[string, BigNumber], SwapOutOfEventObject>
...
export interface SynthSwap extends BaseContract {
	...
	callStatic: {
		...
		rescueFunds(token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>
	...
	filters: {
		...
		'SwapInto(address,uint256)'(from?: string | null, amountReceived?: null): SwapIntoEventFilter
		SwapInto(from?: string | null, amountReceived?: null): SwapIntoEventFilter

		'SwapOutOf(address,uint256)'(from?: string | null, amountReceived?: null): SwapOutOfEventFilter
		SwapOutOf(from?: string | null, amountReceived?: null): SwapOutOfEventFilter
	}
