...
export interface KwentaStakingRewardsInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'stakeEscrow', values: [string, BigNumberish]): string
	...
	encodeFunctionData(functionFragment: 'unstakeEscrow', values: [string, BigNumberish]): string
...
export interface KwentaStakingRewards extends BaseContract {
	...
	functions: {
		...
		escrowedBalanceOf(account: string, overrides?: CallOverrides): Promise<[BigNumber]>
		...
		nonEscrowedBalanceOf(account: string, overrides?: CallOverrides): Promise<[BigNumber]>
	...
	callStatic: {
		...
		stakeEscrow(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>
		...
		unstakeEscrow(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>
	...
	estimateGas: {
		...
		stake(amount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
		...
		unstake(amount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
	...
	populateTransaction: {
		...
		escrowedBalanceOf(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
		...
		nonEscrowedBalanceOf(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
