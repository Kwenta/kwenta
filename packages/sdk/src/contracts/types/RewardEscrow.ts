...
export interface RewardEscrowInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'getVestingEntry', values: [string, BigNumberish]): string
	encodeFunctionData(
	...
	encodeFunctionData(functionFragment: 'numVestingEntries', values: [string]): string
	...
	encodeFunctionData(functionFragment: 'vestingSchedules', values: [string, BigNumberish]): string
...
export interface RewardEscrow extends BaseContract {
	...
	functions: {
		...
		numVestingEntries(account: string, overrides?: CallOverrides): Promise<[BigNumber]>
	...
	estimateGas: {
		...
		vest(entryIDs: BigNumberish[], overrides?: Overrides & { from?: string }): Promise<BigNumber>
	...
	populateTransaction: {
		...
		numVestingEntries(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
