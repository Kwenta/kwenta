...
export interface PerpsV2MarketInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'cancelDelayedOrder', values: [string]): string
	encodeFunctionData(functionFragment: 'cancelOffchainDelayedOrder', values: [string]): string
	...
	encodeFunctionData(functionFragment: 'delayedOrders', values: [string]): string
	encodeFunctionData(functionFragment: 'executeDelayedOrder', values: [string]): string
	encodeFunctionData(
		functionFragment: 'executeOffchainDelayedOrder',
		values: [string, BytesLike[]]
	): string
	encodeFunctionData(functionFragment: 'fillPrice', values: [BigNumberish]): string
	encodeFunctionData(functionFragment: 'flagPosition', values: [string]): string
	encodeFunctionData(functionFragment: 'forceLiquidatePosition', values: [string]): string
