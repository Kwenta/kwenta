...
export interface MultipleMerkleDistributorInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'newMerkleRoot', values: [BytesLike]): string
...
export type MerkleRootAddedEvent = TypedEvent<[BigNumber], MerkleRootAddedEventObject>
...
export interface MultipleMerkleDistributor extends BaseContract {
	...
	callStatic: {
		...
		newMerkleRoot(_merkleRoot: BytesLike, overrides?: CallOverrides): Promise<void>
