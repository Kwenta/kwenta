...
export interface RewardsEscrowV2Interface extends utils.Interface {
  functions: {
...
export interface RewardsEscrowV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardsEscrowV2Interface;
