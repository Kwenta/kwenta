...
export type StakingRewardsUpdatedEvent = TypedEvent<[string], StakingRewardsUpdatedEventObject>
...
export type TradingRewardsUpdatedEvent = TypedEvent<[string], TradingRewardsUpdatedEventObject>
