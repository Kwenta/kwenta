...
import type {
  RewardsEscrowV2,
  RewardsEscrowV2Interface,
} from "../RewardsEscrowV2";
...
export class RewardsEscrowV2__factory {
  static readonly abi = _abi;
  static createInterface(): RewardsEscrowV2Interface {
    return new utils.Interface(_abi) as RewardsEscrowV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RewardsEscrowV2 {
    return new Contract(address, _abi, signerOrProvider) as RewardsEscrowV2;
  }
}
