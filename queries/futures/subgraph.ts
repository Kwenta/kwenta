...
export const getFuturesCumulativeStatById = async function <K extends keyof FuturesCumulativeStatResult>(url: string, options: SingleQueryOptions, args: FuturesCumulativeStatArgs<K>): Promise<Pick<FuturesCumulativeStatResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesCumulativeStats = async function <K extends keyof FuturesCumulativeStatResult>(url: string, options: MultiQueryOptions<FuturesCumulativeStatFilter, FuturesCumulativeStatResult>, args: FuturesCumulativeStatArgs<K>): Promise<Pick<FuturesCumulativeStatResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesCumulativeStatFilter, FuturesCumulativeStatResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesCumulativeStatFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesMarginTransferById = async function <K extends keyof FuturesMarginTransferResult>(url: string, options: SingleQueryOptions, args: FuturesMarginTransferArgs<K>): Promise<Pick<FuturesMarginTransferResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesMarginTransfers = async function <K extends keyof FuturesMarginTransferResult>(url: string, options: MultiQueryOptions<FuturesMarginTransferFilter, FuturesMarginTransferResult>, args: FuturesMarginTransferArgs<K>): Promise<Pick<FuturesMarginTransferResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesMarginTransferFilter, FuturesMarginTransferResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesMarginTransferFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesOneMinStatById = async function <K extends keyof FuturesOneMinStatResult>(url: string, options: SingleQueryOptions, args: FuturesOneMinStatArgs<K>): Promise<Pick<FuturesOneMinStatResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesOneMinStats = async function <K extends keyof FuturesOneMinStatResult>(url: string, options: MultiQueryOptions<FuturesOneMinStatFilter, FuturesOneMinStatResult>, args: FuturesOneMinStatArgs<K>): Promise<Pick<FuturesOneMinStatResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesOneMinStatFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesPositionById = async function <K extends keyof FuturesPositionResult>(url: string, options: SingleQueryOptions, args: FuturesPositionArgs<K>): Promise<Pick<FuturesPositionResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesPositions = async function <K extends keyof FuturesPositionResult>(url: string, options: MultiQueryOptions<FuturesPositionFilter, FuturesPositionResult>, args: FuturesPositionArgs<K>): Promise<Pick<FuturesPositionResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesPositionFilter, FuturesPositionResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesPositionFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesStatById = async function <K extends keyof FuturesStatResult>(url: string, options: SingleQueryOptions, args: FuturesStatArgs<K>): Promise<Pick<FuturesStatResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesStats = async function <K extends keyof FuturesStatResult>(url: string, options: MultiQueryOptions<FuturesStatFilter, FuturesStatResult>, args: FuturesStatArgs<K>): Promise<Pick<FuturesStatResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesStatFilter, FuturesStatResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesStatFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesTradeById = async function <K extends keyof FuturesTradeResult>(url: string, options: SingleQueryOptions, args: FuturesTradeArgs<K>): Promise<Pick<FuturesTradeResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesTrades = async function <K extends keyof FuturesTradeResult>(url: string, options: MultiQueryOptions<FuturesTradeFilter, FuturesTradeResult>, args: FuturesTradeArgs<K>): Promise<Pick<FuturesTradeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesTradeFilter, FuturesTradeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesTradeFilter;
        paginatedOptions.where = { ...options.where };
    }
